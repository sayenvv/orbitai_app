...
export default function AppWorkspacePage() {
  ...
  if (app.slug !== "research-companion") {
    return (
      <div className="flex min-h-0 flex-1 items-center justify-center p-8">
        <p className="text-sm text-muted-foreground">This app workspace is not available yet.</p>
      </div>
    );
  }

  return <ResearchCompanionWorkspacePage workspaceHref={getAppWorkspaceHref(app)} />;
}

function ResearchCompanionWorkspacePage({ workspaceHref }: { workspaceHref: string }) {
